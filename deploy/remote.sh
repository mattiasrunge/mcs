...
FORWARD=(IMAGE_NAME CONTAINER_NAME MCS_PORT MCS_KEY FILES_PATH OLD_PATH VOLATILE_PATH TMP_PATH MCS_MEMORY GPU TZ
         TORCH_CUDA INSTRUCT_MODEL VLM_MODEL WHISPER_MODEL FFMPEG_BUILD FFMPEG_ASSET
