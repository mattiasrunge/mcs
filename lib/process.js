...
const p2i = require("./converters/pdf2image");
...
module.exports = {
    ...
    start: co(function*(filename, destination) {
        ...
        } else if (file.isPdf(source.mimetype)) {
            source.width = 800;
            source.height = source.width * 1.4142;

            if (destination.type === "image") {
                return module.exports.transform(p2i, source, destination);
            }
        }
